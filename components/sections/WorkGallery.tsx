...
export default function WorkGallery() {
  ...
  const ALL_PROJECTS: Project[] = [
    ...
    { id: "03", name: t.workGallery.p3Name, category: t.workGallery.p3Category, tags: [t.workGallery.p3Tag], thumb: "/project3/project3.jpg", large: "/project3/project3.jpg", slug: "costa-otthon" },
  ];
