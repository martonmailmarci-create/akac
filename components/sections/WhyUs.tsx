...
export default function WhyUs() {
  ...
  return (
    <section
      ref={sectionRef}
      className="bg-akac-light px-6 pt-16 pb-24 md:px-[100px] md:pt-[80px] md:pb-[200px]"
    >
      <SectionHeader
        label="/ WHY CHOOSE US"
        title="WHY CHOOSE US?"
      ...
      <div className="flex flex-col md:flex-row gap-6">
        <div ref={leftRef} className="flex-1 bg-akac-offwhite rounded-card overflow-hidden">
          ...
          {rows.map((row, i) => (
            <div key={i} className="flex items-center gap-3 px-8 py-5 border-b border-akac-black/10 last:border-b-0">
        ...
        <div ref={rightRef} className="flex-1 bg-akac-black rounded-card overflow-hidden">
          ...
          {rows.map((row, i) => (
            <div key={i} className="flex items-center gap-3 px-8 py-5 border-b border-akac-light/10 last:border-b-0">
              <div className="w-[7px] h-[7px] bg-akac-orange flex-shrink-0" aria-hidden="true" />
